...
export const VOICE_PACKS = {
  BETTING_OPEN: [
    '/voice-packs/bets-open/1.mp3',
    '/voice-packs/bets-open/2.mp3',
    '/voice-packs/bets-open/3.mp3',
    '/voice-packs/bets-open/4.mp3',
  ],
  LAST_CALL: [
    '/voice-packs/last-call/1.mp3',
    '/voice-packs/last-call/2.mp3',
    '/voice-packs/last-call/3.mp3',
    '/voice-packs/last-call/4.mp3',
  ],
  BETTING_CLOSED: [
    '/voice-packs/bets-closed/1.mp3',
    '/voice-packs/bets-closed/2.mp3',
    '/voice-packs/bets-closed/3.mp3',
    '/voice-packs/bets-closed/4.mp3',
  ],
  RESULT_PLAYER:       '/voice-packs/results/player-win.mp3',
  RESULT_BANKER:       '/voice-packs/results/banker-win.mp3',
  RESULT_TIE:          '/voice-packs/results/tie.mp3',
  RESULT_PLAYER_PAIR:  '/voice-packs/results/player-pair.mp3',
  RESULT_BANKER_PAIR:  '/voice-packs/results/banker-pair.mp3',
  RESULT_NATURAL_EIGHT:'/voice-packs/results/natural-eight.mp3',
  RESULT_NATURAL_NINE: '/voice-packs/results/natural-nine.mp3',
} as const;

export const SFX = {
  BET_OPEN:        '/voice-packs/sfx/bets-open-bell.mp3',
  BET_CLOSED:      '/voice-packs/sfx/bets-closed-bell.mp3',
  CARD_DEAL:       '/voice-packs/sfx/card-deal.mp3',
  CARD_FLIP:       '/voice-packs/sfx/card-flip.mp3',
  CHIP_PLACE:      '/voice-packs/sfx/chip-place.mp3',
  CHIP_STACK:      '/voice-packs/sfx/chip-stack.mp3',
  LAST_5_SECONDS:  '/voice-packs/sfx/5-sec-timer-tick.wav',
  AMBIANCE_LOOP:   '/voice-packs/sfx/casino-ambiance.mp3',
} as const;
